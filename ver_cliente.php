...
// ACTUALIZAR ÚLTIMA VISITA AL ACCEDER A LA PÁGINA
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="eliminar_cliente.php?id=<?php echo $cliente['id']; ?>" class="btn btn-danger btn-block" onclick="return confirm('¿Estás seguro?')">
